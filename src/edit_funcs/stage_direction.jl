function stage_direction(input_fn,output_fn,::Type{<:AbstractEditPhase})
    ...
    stage_directions = ["A division having been called in the House of Representatives","Sitting suspended from","Debate adjourned", "Federation Chamber adjourned at","Question agreed to"]
